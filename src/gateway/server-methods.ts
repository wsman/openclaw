...
export async function handleGatewayRequest(
  ...
  const invokeHandler = (
    ...
    // All handlers run inside a request scope so runtime helpers and hook
    // surfaces can dispatch back into the current gateway request.
    withPluginRuntimeGatewayRequestScope({ context, client, isWebchatConnect }, () =>
      selectedHandler({
        req:
